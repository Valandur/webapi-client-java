...
# **getCollection**
> SubjectCollection getCollection(id, details, accept, pretty)
...
try {
    ...
    System.err.println("Exception when calling PermissionApi#getCollection");
    e.printStackTrace();
}
```
...
<a name="getSubject"></a>
# **getSubject**
> Subject getSubject(id, subId, details, accept, pretty)
...
try {
    ...
    System.err.println("Exception when calling PermissionApi#getSubject");
    e.printStackTrace();
}
```
...
# **listCollections**
> List&lt;SubjectCollection&gt; listCollections(details, accept, pretty)
...
try {
    ...
    System.err.println("Exception when calling PermissionApi#listCollections");
    e.printStackTrace();
}
```
...
# **listSubjects**
> List&lt;Subject&gt; listSubjects(id, details, accept, pretty)
...
try {
    ...
    System.err.println("Exception when calling PermissionApi#listSubjects");
    e.printStackTrace();
}
```
