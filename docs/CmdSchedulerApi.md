...
<a name="deleteTask"></a>
# **deleteTask**
> CommandTask deleteTask(name, details, accept, pretty)
...
//import io.swagger.client.api.CmdSchedulerApi;
...
CmdSchedulerApi apiInstance = new CmdSchedulerApi();
String name = "name_example"; // String | The name of the task
...
try {
    ...
    System.err.println("Exception when calling CmdSchedulerApi#deleteTask");
    e.printStackTrace();
}
```
...
<a name="listTasks"></a>
# **listTasks**
> List&lt;CommandTask&gt; listTasks(details, accept, pretty)
...
try {
    ...
    System.err.println("Exception when calling CmdSchedulerApi#listTasks");
    e.printStackTrace();
}
```
