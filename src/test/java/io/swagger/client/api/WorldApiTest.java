...
public class WorldApiTest {
    ...
    public void executeMethodTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        ExecuteMethodResponse response = api.executeMethod(world, body, details, accept, pretty);
     ...
     */
    @Test
    public void modifyWorldTest() throws ApiException {
        String world = null;
        UpdateWorldRequest body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
