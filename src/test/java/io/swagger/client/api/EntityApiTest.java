...
public class EntityApiTest {
    ...
    public void createEntityTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        Entity response = api.createEntity(body, details, accept, pretty);
    ...
    public void executeMethodTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        ExecuteMethodResponse response = api.executeMethod(entity, body, details, accept, pretty);
    ...
    public void getEntityTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        Entity response = api.getEntity(entity, details, accept, pretty);
    ...
    public void listEntitiesTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        List<Entity> response = api.listEntities(world, type, min, max, limit, details, accept, pretty);
     ...
     */
    @Test
    public void modifyEntityTest() throws ApiException {
        UUID entity = null;
        UpdateEntityRequest body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
        Entity response = api.modifyEntity(entity, body, details, accept, pretty);
    ...
    public void removeEntityTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        Entity response = api.removeEntity(entity, details, accept, pretty);
