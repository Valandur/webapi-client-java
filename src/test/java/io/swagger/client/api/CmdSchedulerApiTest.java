...
/**
 * API tests for CmdSchedulerApi
 */
@Ignore
public class CmdSchedulerApiTest {

    private final CmdSchedulerApi api = new CmdSchedulerApi();
    ...
    public void deleteTaskTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        CommandTask response = api.deleteTask(name, details, accept, pretty);
    ...
    public void listTasksTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        List<CommandTask> response = api.listTasks(details, accept, pretty);
