...
public class MmcTicketsApiTest {
    ...
    public void getTicketTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        MMCTicketsTicket response = api.getTicket(id, details, accept, pretty);
    ...
    public void listTicketsTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        List<MMCTicketsTicket> response = api.listTickets(details, accept, pretty);
     ...
     */
    @Test
    public void modifyTicketTest() throws ApiException {
        Integer id = null;
        MMCTicketsTicket body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
        MMCTicketsTicket response = api.modifyTicket(id, body, details, accept, pretty);
