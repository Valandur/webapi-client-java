...
/**
 * API tests for RedProtectApi
 */
@Ignore
public class RedProtectApiTest {

    private final RedProtectApi api = new RedProtectApi();
    ...
    public void createRegionTest() throws ApiException {
        RedProtectRegion body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
        RedProtectRegion response = api.createRegion(body, details, accept, pretty);
    ...
    public void deleteRegionTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        RedProtectRegion response = api.deleteRegion(id, details, accept, pretty);
    ...
    public void getRegionTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        RedProtectRegion response = api.getRegion(id, details, accept, pretty);
    ...
    public void listRegionsTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        List<RedProtectRegion> response = api.listRegions(world, details, accept, pretty);
     ...
     */
    @Test
    public void modifyRegionTest() throws ApiException {
        String id = null;
        RedProtectRegion body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
        RedProtectRegion response = api.modifyRegion(id, body, details, accept, pretty);
