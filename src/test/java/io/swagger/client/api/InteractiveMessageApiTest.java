...
/**
 * API tests for InteractiveMessageApi
 */
@Ignore
public class InteractiveMessageApiTest {

    private final InteractiveMessageApi api = new InteractiveMessageApi();
    ...
    public void getMessageTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        InteractiveMessage response = api.getMessage(uuid, details, accept, pretty);
    ...
    public void listMessagesTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        List<InteractiveMessage> response = api.listMessages(details, accept, pretty);
    ...
    public void sendMessageTest() throws ApiException {
        InteractiveMessage body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
        InteractiveMessage response = api.sendMessage(body, details, accept, pretty);
