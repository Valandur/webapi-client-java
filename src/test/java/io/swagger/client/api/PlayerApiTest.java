...
public class PlayerApiTest {
    ...
    public void executeMethodTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        ExecuteMethodResponse response = api.executeMethod(player, body, details, accept, pretty);
     ...
     */
    @Test
    public void modifyPlayerTest() throws ApiException {
        String player = null;
        UpdatePlayerRequest body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
