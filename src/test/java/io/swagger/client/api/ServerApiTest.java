...
public class ServerApiTest {
    ...
    public void listPropertiesTest() throws ApiException {
        ...
        String accept = null;
        Boolean pretty = null;
        List<ServerProperty> response = api.listProperties(details, accept, pretty);
     ...
     */
    @Test
    public void modifyPropertiesTest() throws ApiException {
        Object body = null;
        Boolean details = null;
        String accept = null;
        Boolean pretty = null;
        List<ServerProperty> response = api.modifyProperties(body, details, accept, pretty);
