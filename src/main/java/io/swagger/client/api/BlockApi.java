...
public class BlockApi {
    ...
    private com.squareup.okhttp.Call cancelBlockOperationCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/block/op/{uuid}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<BlockOperationResponse> cancelBlockOperationWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = cancelBlockOperationCall(uuid, null, null);
    ...
    private com.squareup.okhttp.Call changeBlockOperationCall(String uuid, Data data, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<BlockOperationResponse> changeBlockOperationWithHttpInfo(String uuid, Data data) throws ApiException {
        com.squareup.okhttp.Call call = changeBlockOperationCall(uuid, data, null, null);
        Type localVarReturnType = new TypeToken<BlockOperationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call getBlockCall(String world, String x, String y, String z, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/block/{world}/{x}/{y}/{z}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<SingleBlock> getBlockWithHttpInfo(String world, String x, String y, String z) throws ApiException {
        com.squareup.okhttp.Call call = getBlockCall(world, x, y, z, null, null);
    ...
    private com.squareup.okhttp.Call getBlockOperationCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<BlockOperationResponse> getBlockOperationWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = getBlockOperationCall(uuid, null, null);
        Type localVarReturnType = new TypeToken<BlockOperationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call getBlockOperationsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/block/op".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<BlockOperationsList> getBlockOperationsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getBlockOperationsCall(null, null);
    ...
    private com.squareup.okhttp.Call startBlockOperationCall(List<BlockOperationNew> request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<BlockOperationResponse> startBlockOperationWithHttpInfo(List<BlockOperationNew> request) throws ApiException {
        com.squareup.okhttp.Call call = startBlockOperationCall(request, null, null);
        Type localVarReturnType = new TypeToken<BlockOperationResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
