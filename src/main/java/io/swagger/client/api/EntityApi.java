...
public class EntityApi {
    ...
    private com.squareup.okhttp.Call changeEntityCall(String uuid, UpdateEntityRequest updateEntityRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/entity/{uuid}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<EntityResponse> changeEntityWithHttpInfo(String uuid, UpdateEntityRequest updateEntityRequest) throws ApiException {
        com.squareup.okhttp.Call call = changeEntityCall(uuid, updateEntityRequest, null, null);
    ...
    private com.squareup.okhttp.Call createEntityCall(CreateEntityRequest createEntityRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/entity".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<EntityResponse> createEntityWithHttpInfo(CreateEntityRequest createEntityRequest) throws ApiException {
        com.squareup.okhttp.Call call = createEntityCall(createEntityRequest, null, null);
        Type localVarReturnType = new TypeToken<EntityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call destroyEntityCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<EntityResponse> destroyEntityWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = destroyEntityCall(uuid, null, null);
        Type localVarReturnType = new TypeToken<EntityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call executeEntityMethodCall(String uuid, RawRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<EntityMethodResult> executeEntityMethodWithHttpInfo(String uuid, RawRequest request) throws ApiException {
        com.squareup.okhttp.Call call = executeEntityMethodCall(uuid, request, null, null);
    ...
    private com.squareup.okhttp.Call getEntitiesCall(String details, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<EntitiesList> getEntitiesWithHttpInfo(String details) throws ApiException {
        com.squareup.okhttp.Call call = getEntitiesCall(details, null, null);
    ...
    private com.squareup.okhttp.Call getEntityCall(String uuid, String fields, String methods, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<EntityResponse> getEntityWithHttpInfo(String uuid, String fields, String methods) throws ApiException {
        com.squareup.okhttp.Call call = getEntityCall(uuid, fields, methods, null, null);
        Type localVarReturnType = new TypeToken<EntityResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
