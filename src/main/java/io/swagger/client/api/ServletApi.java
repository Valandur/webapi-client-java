...
public class ServletApi {
    ...
    private com.squareup.okhttp.Call getLoadedServletsCall(final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        

        // create path and map variables
        String localVarPath = "/servlet".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<ServletsResponse> getLoadedServletsWithHttpInfo() throws ApiException {
        com.squareup.okhttp.Call call = getLoadedServletsCall(null, null);
