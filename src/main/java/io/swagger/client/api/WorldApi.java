...
public class WorldApi {
    ...
    private com.squareup.okhttp.Call changeWorldCall(String uuid, UpdateWorldRequest updateWorldRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        String localVarPath = "/world/{uuid}".replaceAll("\\{format\\}","json")
    ...
    public ApiResponse<WorldResponse> changeWorldWithHttpInfo(String uuid, UpdateWorldRequest updateWorldRequest) throws ApiException {
        com.squareup.okhttp.Call call = changeWorldCall(uuid, updateWorldRequest, null, null);
    ...
    private com.squareup.okhttp.Call createWorldCall(CreateWorldRequest createWorldRequest, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        // create path and map variables
        String localVarPath = "/world".replaceAll("\\{format\\}","json");
    ...
    public ApiResponse<WorldResponse> createWorldWithHttpInfo(CreateWorldRequest createWorldRequest) throws ApiException {
        com.squareup.okhttp.Call call = createWorldCall(createWorldRequest, null, null);
        Type localVarReturnType = new TypeToken<WorldResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call deleteWorldCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<WorldResponse> deleteWorldWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = deleteWorldCall(uuid, null, null);
        Type localVarReturnType = new TypeToken<WorldResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call executeWorldMethodCall(String uuid, RawRequest request, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    public ApiResponse<ExecuteWorldMethodResponse> executeWorldMethodWithHttpInfo(String uuid, RawRequest request) throws ApiException {
        com.squareup.okhttp.Call call = executeWorldMethodCall(uuid, request, null, null);
    ...
    private com.squareup.okhttp.Call getChunkCall(String uuid, String x, String z, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/world/{uuid}/chunk/{x}/{z}".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "uuid" + "\\}", apiClient.escapeString(uuid.toString()))
    ...
    public ApiResponse<ChunkResponse> getChunkWithHttpInfo(String uuid, String x, String z) throws ApiException {
        com.squareup.okhttp.Call call = getChunkCall(uuid, x, z, null, null);
    ...
    private com.squareup.okhttp.Call getChunksCall(String uuid, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        ...
        // create path and map variables
        String localVarPath = "/world/{uuid}/chunk".replaceAll("\\{format\\}","json")
        .replaceAll("\\{" + "uuid" + "\\}", apiClient.escapeString(uuid.toString()));
    ...
    public ApiResponse<ChunksResponse> getChunksWithHttpInfo(String uuid) throws ApiException {
        com.squareup.okhttp.Call call = getChunksCall(uuid, null, null);
    ...
    private com.squareup.okhttp.Call getWorldCall(String uuid, String fields, String methods, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<WorldResponse> getWorldWithHttpInfo(String uuid, String fields, String methods) throws ApiException {
        com.squareup.okhttp.Call call = getWorldCall(uuid, fields, methods, null, null);
        Type localVarReturnType = new TypeToken<WorldResponse>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
    ...
    private com.squareup.okhttp.Call getWorldsCall(String details, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
    ...
    public ApiResponse<WorldsResponse> getWorldsWithHttpInfo(String details) throws ApiException {
        com.squareup.okhttp.Call call = getWorldsCall(details, null, null);
