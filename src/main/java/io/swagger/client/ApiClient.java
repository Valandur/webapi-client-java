...
public class ApiClient {
    ...
    private String basePath = "http://<host>/api";
    ...
    public ApiClient() {
        ...
        authentications.put("headerKey", new ApiKeyAuth("header", "x-webapi-key"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://<host>/api
