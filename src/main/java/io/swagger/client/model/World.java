...
public class World   {
  ...
  **/
   ...
   * @return uuid
  **/
  @ApiModelProperty(example = "null", value = "The unique id of the world.")
   ...
   * @return link
  **/
  @ApiModelProperty(example = "null", value = "The API URL which contains detailed information about this world.")
