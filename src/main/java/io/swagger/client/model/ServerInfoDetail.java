...
public class ServerInfoDetail   {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "The unique id of the api.")
  public String getId() {
    return id;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "The name of the api.")
   ...
   * @return version
  **/
  @ApiModelProperty(example = "null", value = "The version of the api.")
   ...
   * @return description
  **/
  @ApiModelProperty(example = "null", value = "The description of the api.")
   ...
   * @return url
  **/
  @ApiModelProperty(example = "null", value = "The website of the api.")
   ...
   * @return authors
  **/
  @ApiModelProperty(example = "null", value = "The list of authors that worked on the api.")
