...
public class MessageRequest   {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "The id of the message. This will be sent back in the reply, so you can identify the request.")
  public String getId() {
    return id;
  }
   ...
   * @return target
  **/
  @ApiModelProperty(example = "null", value = "The UUID of the player this message is sent to.")
   ...
   * @return message
  **/
  @ApiModelProperty(example = "null", value = "The message sent to the player. Text formatting can be applied with ampersand formatting.")
   ...
   * @return once
  **/
  @ApiModelProperty(example = "null", value = "True if the target can only select one response for this message (further responses are not sent to the webhook endpoint) ")
   ...
   * @return options
  **/
  @ApiModelProperty(example = "null", value = "These are the options the player can choose from. The key is sent back to the server, the value is displayed to the player. ")
