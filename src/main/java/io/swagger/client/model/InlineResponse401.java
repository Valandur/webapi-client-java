...
public class InlineResponse401 {
   ...
   * @return error
  **/
  @ApiModelProperty(example = "Unauthorized", value = "The error message describing the error")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "401", value = "The status code of the error (also provided in the HTTP header)")
