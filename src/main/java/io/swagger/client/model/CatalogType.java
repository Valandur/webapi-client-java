...
public class CatalogType   {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "The internal id used to identify this object.")
  public String getId() {
    return id;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "The human readable name of this object.")
