...
public class InlineResponse403 {
   ...
   * @return error
  **/
  @ApiModelProperty(example = "Access denied", value = "The error message describing the error")
  ...
  public InlineResponse403 status(Integer status) {
    this.status = status;
    return this;
  }
   ...
   * @return status
  **/
  @ApiModelProperty(example = "403", value = "The status code of the error (also provided in the HTTP header)")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.error, inlineResponse403.error) &&
        Objects.equals(this.status, inlineResponse403.status);
  }
