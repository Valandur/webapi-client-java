...
public class CommandFull   {
   ...
   * @return aliases
  **/
  @ApiModelProperty(example = "null", value = "All the aliases with which the command can be executed.")
   ...
   * @return usage
  **/
  @ApiModelProperty(example = "null", value = "The usage instructions for the command.")
   ...
   * @return help
  **/
  @ApiModelProperty(example = "null", value = "More information about the command.")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.aliases, commandFull.aliases) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(aliases, usage, help);
  }
