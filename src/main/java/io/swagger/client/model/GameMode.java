...
public class GameMode {
   ...
   * @return id
  **/
  @ApiModelProperty(required = true, value = "The unique id of the game mode")
  public String getId() {
    return id;
  }
  ...
  public GameMode name(String name) {
    this.name = name;
    return this;
  }
   ...
   * @return name
  **/
  @ApiModelProperty(required = true, value = "The name of the game mode")
