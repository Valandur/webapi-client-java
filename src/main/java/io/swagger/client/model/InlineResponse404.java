...
public class InlineResponse404 {
   ...
   * @return error
  **/
  @ApiModelProperty(example = "Not found", value = "The error message describing the error")
   ...
   * @return status
  **/
  @ApiModelProperty(example = "404", value = "The status code of the error (also provided in the HTTP header)")
