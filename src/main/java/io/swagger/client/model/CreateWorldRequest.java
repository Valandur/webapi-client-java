...
public class CreateWorldRequest   {
  ...
  **/
   ...
   * @return dimension
  **/
  @ApiModelProperty(example = "null", value = "The dimension of the world to use. Check `/registry/org.spongepowered.api.world.DimensionType`.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "True to generate bonus chests, false otherwise.")
