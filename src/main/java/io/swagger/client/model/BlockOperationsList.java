...
public class BlockOperationsList   {
  ...
  private List<BlockOperation> operations = new ArrayList<BlockOperation>();

  public BlockOperationsList ok(Ok ok) {
    this.ok = ok;
    return this;
  }
  ...
  **/
   ...
   * @return operations
  **/
  @ApiModelProperty(example = "null", value = "A list of block operations.")
