...
public class ItemStack   {
   ...
   * @return id
  **/
  @ApiModelProperty(example = "null", value = "The unique id of the item")
  public String getId() {
    return id;
  }
   ...
   * @return quantity
  **/
  @ApiModelProperty(example = "null", value = "The amount of items in this stack")
   ...
   * @return data
  **/
  @ApiModelProperty(example = "null", value = "Any additional data attached to the items.")
