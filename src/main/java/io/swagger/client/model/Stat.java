...
public class Stat {
  ...
  public Stat timestamp(BigDecimal timestamp) {
   ...
   * @return timestamp
  **/
  @ApiModelProperty(value = "The timestamp (epoch seconds) at which the value was recorded")
   ...
   * @return value
  **/
  @ApiModelProperty(value = "The recorded value for this metric.")
