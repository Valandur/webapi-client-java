...
public class ServerInfo   {
   ...
   * @return motd
  **/
  @ApiModelProperty(example = "null", value = "The message of the day set on the server.")
   ...
   * @return players
  **/
  @ApiModelProperty(example = "null", value = "The amount of players currently playing on the server")
   ...
   * @return maxPlayers
  **/
  @ApiModelProperty(example = "null", value = "The maximum amount of players allowed on the server")
   ...
   * @return uptimeTicks
  **/
  @ApiModelProperty(example = "null", value = "The number of ticks the server has been running")
   ...
   * @return tps
  **/
  @ApiModelProperty(example = "null", value = "The average ticks per second the server is running with. 20 is ideal.")
   ...
   * @return hasWhitelist
  **/
  @ApiModelProperty(example = "null", value = "True if the server has a whitelist, false otherwise.")
  ...
  **/
  @ApiModelProperty(example = "null", value = "The minecraft version running on the server.")
