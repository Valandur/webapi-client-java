...
public class CommandCall   {
  ...
  **/
   ...
   * @return command
  **/
  @ApiModelProperty(example = "null", value = "The name of the command that was executed.")
   ...
   * @return args
  **/
  @ApiModelProperty(example = "null", value = "The command arguments passed to the command.")
   ...
   * @return source
  **/
  @ApiModelProperty(example = "null", value = "An object describing the source (executor) of the command. Usually a player or the console.")
