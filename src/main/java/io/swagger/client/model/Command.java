...
public class Command   {
   ...
   * @return name
  **/
  @ApiModelProperty(example = "null", value = "The main name of the command.")
   ...
   * @return description
  **/
  @ApiModelProperty(example = "null", value = "Describes what the command does.")
   ...
   * @return link
  **/
  @ApiModelProperty(example = "null", value = "The API URL which contains detailed information about this command.")
